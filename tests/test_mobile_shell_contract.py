...
class MobileShellContractTests(unittest.TestCase):
    ...
    def test_mobile_m2_qr_gate_routes_from_journal_and_checks_player_tasks(self) -> None:
        ...
        self.assertIn("func _ordinary_qr_leave_in_place_note", main)
        self.assertIn("После награды не забирайте", main)
        self.assertIn('qr_mode == "repeatable_scene"', main)
        self.assertIn('qr_mode == "always_available_scene"', main)
