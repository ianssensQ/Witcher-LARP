...
def _validate_references(
    ...
    reference_checks = [
        ("player_codes.csv", "player_id", "players.csv"),
        ("players.csv", "player_code_id", "player_codes.csv"),
        ("domains.csv", "lord_player_id", "players.csv"),
        ("auto_timers.csv", "act_id", "acts.csv"),
        ("physical_announcements.csv", "act_id", "acts.csv"),
        ("map_nodes.csv", "territory_id", "territories.csv"),
        ("territories.csv", "owner_domain_id", "domains.csv"),
        ("territories.csv", "neutral_defense_profile_id", "mobs.csv"),
        ("movement_pools.csv", "domain_id", "domains.csv"),
        ("movement_pools.csv", "act_id", "acts.csv"),
        ("territory_claims.csv", "territory_id", "territories.csv"),
        ("territory_claims.csv", "claimant_domain_id", "domains.csv"),
        ("pending_tick_rewards.csv", "domain_id", "domains.csv"),
        ("pending_tick_rewards.csv", "territory_id", "territories.csv"),
        ("pending_tick_rewards.csv", "reward_id", "rewards.csv"),
        ("army_reserves.csv", "domain_id", "domains.csv"),
        ("army_reserves.csv", "card_id", "army_unit_cards.csv"),
        ("garrisons.csv", "territory_id", "territories.csv"),
        ("garrisons.csv", "domain_id", "domains.csv"),
        ("garrisons.csv", "card_id", "army_unit_cards.csv"),
        ("army_unit_cards.csv", "source_id", "buildings.csv"),
        ("recruit_markets.csv", "domain_id", "domains.csv"),
        ("recruit_markets.csv", "card_id", "army_unit_cards.csv"),
        ("cards.csv", "army_unit_card_id", "army_unit_cards.csv"),
        ("pve_scenarios.csv", "act_id", "acts.csv"),
        ("pve_scenarios.csv", "check_policy", "check_policies.csv"),
        ("pve_scenarios.csv", "combat_profile_id", "mobs.csv"),
        ("pve_scenarios.csv", "reward_id", "rewards.csv"),
        ("qr_objects.csv", "scenario_id", "pve_scenarios.csv"),
        ("qr_objects.csv", "act_id", "acts.csv"),
        ("qr_objects.csv", "location_node_id", "map_nodes.csv"),
        ("gwent_decks.csv", "player_id", "players.csv"),
        ("gwent_decks.csv", "leader_card_id", "gwent_cards.csv"),
        ("gwent_matches.csv", "challenger_id", "players.csv"),
        ("gwent_matches.csv", "target_id", "players.csv"),
        ("orders.csv", "lord_id", "players.csv"),
        ("orders.csv", "target_player_id", "players.csv"),
        ("orders.csv", "escrow_reward_id", "rewards.csv"),
        ("potion_markets.csv", "potion_id", "potions.csv"),
        ("personal_goals.csv", "player_id", "players.csv"),
        ("personal_goals.csv", "act_id", "acts.csv"),
        ("personal_goals.csv", "final_hook_id", "final_hooks.csv"),
        ("goal_tracks.csv", "goal_id", "personal_goals.csv"),
        ("goal_flags.csv", "goal_id", "personal_goals.csv"),
        ("favorites.csv", "sorceress_id", "players.csv"),
        ("favorites.csv", "favored_player_id", "players.csv"),
        ("final_summary.csv", "final_act_id", "acts.csv"),
        ("challenge_tokens.csv", "act_id", "acts.csv"),
    ]
    for file_name, column, target_file in reference_checks:
        errors.extend(_reference_errors(tables[file_name], column, ids[target_file]))
...
def _validate_orders(
    ...
    active_statuses = {
        ...
        if record.values["is_active"] == "true"
    }
        ...
        if (
            ...
            errors.append(
                ImportErrorDetail(
                    ...
                    row=record.row_number,
                    record_id=record.values["reward_id"],
                    message="Rare, legendary, artifact or cascade-prone rewards must require master approval.",
                )
            )
